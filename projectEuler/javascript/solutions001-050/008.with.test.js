...
test("1 largestProductinaSeries(4) should return 5832.", () => {
  expect(largestProductinaSeries(4)).toBe(5832);
});

test("2 largestProductinaSeries(13) should return 23514624000.", () => {
